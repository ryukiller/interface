...
import { abi as STAKING_REWARDS_ABI } from '@ariswap/liquidity-staker/build/StakingRewards.json'
...
import { DAI, ARI, USDC_MAINNET, USDT, WBTC, WRAPPED_NATIVE_CURRENCY } from '../../constants/tokens'
