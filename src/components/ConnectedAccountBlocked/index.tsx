    ...
    <Modal isOpen={props.isOpen} onDismiss={Function.prototype()}>
      <ContentWrapper>
        ...
        <ThemedText.Main fontSize={14} marginBottom={12}>
          <Trans>This address is blocked on the Ariswap Labs interface because it is associated with one or more</Trans>{' '}
          <ExternalLink href="https://help.Ariswap.org/en/articles/6149816">
        ...
        <Copy iconSize={12} toCopy="compliance@ariswap.org" color={theme.primary1} iconPosition="right">
          compliance@ariswap.org
        </Copy>
      </ContentWrapper>
    </Modal>
  )
