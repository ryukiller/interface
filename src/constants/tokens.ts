import { Currency, Ether, NativeCurrency, Token, WETH9 } from '@ariswap/sdk-core'
import invariant from 'tiny-invariant'

import { ARI_ADDRESS } from './addresses'
...
export const ARI: { [chainId: number]: Token } = {
  [SupportedChainId.MAINNET]: new Token(SupportedChainId.MAINNET, ARI_ADDRESS[1], 18, 'ARI', 'Ariswap'),
  [SupportedChainId.RINKEBY]: new Token(SupportedChainId.RINKEBY, ARI_ADDRESS[4], 18, 'ARI', 'Ariswap'),
  [SupportedChainId.ROPSTEN]: new Token(SupportedChainId.ROPSTEN, ARI_ADDRESS[3], 18, 'ARI', 'Ariswap'),
  [SupportedChainId.GOERLI]: new Token(SupportedChainId.GOERLI, ARI_ADDRESS[5], 18, 'ARI', 'Ariswap'),
  [SupportedChainId.KOVAN]: new Token(SupportedChainId.KOVAN, ARI_ADDRESS[42], 18, 'ARI', 'Ariswap'),
}
